...
acid.define([], function() {
	...
	// lazy load scene.
	//----------------------	
	acid.graphics.assets.load("json", ["cubes/assets/cube.json",
		 							   "cubes/assets/floor.json",
		 							   "cubes/assets/wall.json",
		 							   "cubes/assets/light.json",
									   "cubes/assets/car.json"])
		.then(function(models) {				  
		acid.graphics.assets.load("texture", ["cubes/assets/cube.jpg",
			 								  "cubes/assets/floor.jpg",
			 								  "cubes/assets/wall.jpg"])
